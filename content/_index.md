...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: >
        <div dir="rtl" style="text-align: right; font-size: 1.1rem; line-height: 1.8; color: var(--text-color);">
        مدل‌های زبانی بزرگ به‌زودی به تمام عرصه‌ها پا خواهند گذاشت. گنجینه‌ی دانش بشری اکنون درون این مدل‌ها جای گرفته و آن‌ها را به ابزارهایی بی‌نهایت قدرتمند بدل کرده است. کافی است تصور کنید که در کمتر از یک دهه، این فناوری چه انقلاب عظیمی به پا کرده است. اما نکته‌ی هشداردهنده اینجاست: بسیاری نمی‌دانند که ما هنوز درنیافته‌ایم هر جمله‌ای که هوش مصنوعی تولید می‌کند، دقیقاً از کدام بخش مدل، با چه سازوکاری و متناسب با کدام متغیرها بیرون می‌آید. به باور من، هوش مصنوعی نیز همچون مغز ما انسان‌ها که حاصل میلیون‌ها سال تکامل است، مسیر تکامل را می‌پیماید؛ اما با سرعتی که هرگز قابل قیاس با فرگشت زیستی نیست. و در پایان، تنها سلاح ما برای آنکه این ذهن‌های ماشینی بر سرنوشت جهان چیره نشوند، چیزی نیست جز شناخت خود آن ذهن‌های ماشینی.
        </div>
    design:
      columns: '1'
  - block: markdown
